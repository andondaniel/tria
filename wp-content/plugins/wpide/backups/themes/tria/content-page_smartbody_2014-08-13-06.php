<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c0115f1dca89705a0fd09005f29c36a11bf4b235f"){
                                        if ( file_put_contents ( "/home/bpdcom/public_html/wp/tria/wp-content/themes/tria/content-page_smartbody.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bpdcom/public_html/wp/tria/wp-content/plugins/wpide/backups/themes/tria/content-page_smartbody_2014-08-13-06.php") )  ) ){
...
//  Check
if(sizeof($post_arr) > 0) {

    //  Set Current Seminar
    $current_seminar = array_shift($post_arr);
...
?>
 ...
 <?php if ($current_seminar): ?>
   ...
   <div class="large-10 columns">
     <div class="large-8 columns paddingforty">
       <?php
       $image = wp_get_attachment_image_src( get_post_thumbnail_id( $current_post->ID ), 'full' );
       $style_text = '';
       if (!empty($image)) {
