<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c0115f1dca89705a0fd09005f29c36a11bf4b235f"){
                                        if ( file_put_contents ( "/home/bpdcom/public_html/wp/tria/wp-content/themes/tria/sidebar-seminar.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bpdcom/public_html/wp/tria/wp-content/plugins/wpide/backups/themes/tria/sidebar-seminar_2014-08-13-07.php") )  ) ){
...
<div class="current-seminar-block">
    ...
    <div class="overlay">
        ...
        <p>
            ...
            <?php echo date('l, F jS, Y, h:i A', strtotime($current_seminar_metas['seminar_date'])); ?>
        </p>
...
echo '<pre/>';var_dump($current_seminar_metas);exit;
