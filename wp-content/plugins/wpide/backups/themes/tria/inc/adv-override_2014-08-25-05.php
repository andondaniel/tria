<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c0115f1dca89705a0fd09005f29c36a757e60a815"){
                                        if ( file_put_contents ( "/home/bpdcom/public_html/wp/tria/wp-content/themes/tria/inc/adv-override.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bpdcom/public_html/wp/tria/wp-content/plugins/wpide/backups/themes/tria/inc/adv-override_2014-08-25-05.php") )  ) ){
...
function tria_register_post_types() {
    ...
    cpte_register_post_type(POST_TYPE_SEMINAR, 'SmartBody Seminar', 'SmartBody Seminars', array('custom-fields', 'thumbnail'));
    ...
    cpte_register_post_type(POST_TYPE_DOCTOR, 'Provider', 'Providers');

    //  Register Custom Post Type : Condition
    cpte_register_post_type(POST_TYPE_CONDITION, 'Condition', 'Conditions', array('title', 'editor', 'excerpt'));
