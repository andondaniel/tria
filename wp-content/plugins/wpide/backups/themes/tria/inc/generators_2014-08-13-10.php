<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c0115f1dca89705a0fd09005f29c36a11bf4b235f"){
                                        if ( file_put_contents ( "/home/bpdcom/public_html/wp/tria/wp-content/themes/tria/inc/generators.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bpdcom/public_html/wp/tria/wp-content/plugins/wpide/backups/themes/tria/inc/generators_2014-08-13-10.php") )  ) ){
...
function wen_get_past_seminars($ref, $years_count = null) {
    ...
    //  Loop Each
    foreach($past_seminars as $year => $pSeminars) {

        //  Sort the Seminars
        krsort($pSeminars);

        //  Store
        $past_seminars[$year] = $pSeminars;
    }
