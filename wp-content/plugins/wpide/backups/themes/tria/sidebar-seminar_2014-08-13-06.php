<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3c0115f1dca89705a0fd09005f29c36a11bf4b235f"){
                                        if ( file_put_contents ( "/home/bpdcom/public_html/wp/tria/wp-content/themes/tria/sidebar-seminar.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/bpdcom/public_html/wp/tria/wp-content/plugins/wpide/backups/themes/tria/sidebar-seminar_2014-08-13-06.php") )  ) ){
...
<div class="current-seminar-block">
    ...
    <div class="overlay">
        <h6>Up Next</h6>
        <p>
            <b><?php echo apply_filters('the_title', $current_seminar->post_title); ?></b>
            <?php echo date('l, F jS, Y,', strtotime($current_seminar_metas['seminar_date'])); ?>
...
Tuesday, October 28, 2014, 7 P.M.</p>
<p><b>Curabitur pharetra, augue ac blandit varius, turpis quam luctus ligula?</b>
Wednesday, October 29, 2014, 7 P.M. </p>
